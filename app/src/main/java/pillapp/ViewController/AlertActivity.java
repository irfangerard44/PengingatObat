...
public class AlertActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alert.show(getSupportFragmentManager(), "Pengingat Obat");
    }
    ...
    public void doNeutralClick(String pillName){
        ...
        Toast.makeText(getBaseContext(), "Pengingat " + pillName + " di tunda 10 menit", Toast.LENGTH_SHORT).show();
    ...
    public void doPositiveClick(String pillName){
        ...
        Toast.makeText(getBaseContext(),  pillName + " telah diminum "+ nonMilitaryHour + ":" + stringMinute + " " + am_pm + ".", Toast.LENGTH_SHORT).show();
